                ...
                <div className="container mx-auto px-4 md:px-6 py-16 md:py-32 max-w-5xl">
                    ...
                    >
                        ...
                        <div className="relative">
                            <div className={`absolute top-6 bottom-10 w-[2px] bg-gradient-to-b from-[var(--pop-lime)]/60 to-[var(--pop-lime)]/20 hidden md:block rounded-full ${direction === 'rtl' ? 'right-[1.2rem]' : 'left-[1.2rem]'}`} />
