...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/en/work/counts/`,
      lastModified: new Date('2026-07-03'),
      changeFrequency: 'monthly',
      priority: 0.8,
      alternates: { languages: { en: `${baseUrl}/en/work/counts/`, he: `${baseUrl}/he/work/counts/`, 'x-default': `${baseUrl}/he/work/counts/` } },
    },
    {
      url: `${baseUrl}/he/work/counts/`,
      lastModified: new Date('2026-07-03'),
      changeFrequency: 'monthly',
      priority: 0.8,
      alternates: { languages: { en: `${baseUrl}/en/work/counts/`, he: `${baseUrl}/he/work/counts/`, 'x-default': `${baseUrl}/he/work/counts/` } },
    ...
    {
      url: `${baseUrl}/en/work/brt/`,
      lastModified: new Date('2026-07-03'),
      changeFrequency: 'monthly',
      priority: 0.8,
      alternates: { languages: { en: `${baseUrl}/en/work/brt/`, he: `${baseUrl}/he/work/brt/`, 'x-default': `${baseUrl}/he/work/brt/` } },
    },
    {
      url: `${baseUrl}/he/work/brt/`,
      lastModified: new Date('2026-07-03'),
      changeFrequency: 'monthly',
      priority: 0.8,
      alternates: { languages: { en: `${baseUrl}/en/work/brt/`, he: `${baseUrl}/he/work/brt/`, 'x-default': `${baseUrl}/he/work/brt/` } },
