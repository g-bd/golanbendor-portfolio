...
export const speakingCopy: Record<Language, SpeakingCopy> = {
  en: {
    ...
    talkHint: 'A silent excerpt plays here; the full talk with sound loads from YouTube (privacy-enhanced) only when you press it.',
  ...
  he: {
    ...
    talkHint: 'כאן מתנגן קטע שקט; ההרצאה המלאה עם קול נטענת מ־YouTube (במצב פרטיות מוגברת) רק בלחיצה.',
