...
// Full-size clippings (lightbox). The cards derive a `-sm.jpg` preview from each name (see PressDossier).
const newsImages = ['article news.jpg', 'article news 2.jpg', 'article news 3.jpg'];
